...
// indent -gnu -br -cli2 -lp -nut -l100 i2c.c
...
int
i2c_read (I2C_Control * dev, bool lastf, uint8_t * val8)
{
...
//      longjmp (i2c_exception, I2C_Read_Timeout);
  ...
  *val8 = i2c_get_data (dev->device);
  return I2C_Ok;
}

int
i2c_read_bytes (I2C_Control * dev, uint8_t * val8, uint8_t len)
{
  int i = 0;
