...
int i2c_start_addr(I2C_Control *dev,uint8_t addr,enum I2C_RW rw);
int i2c_write(I2C_Control *dev,uint8_t byte);
int i2c_write_restart(I2C_Control *dev,uint8_t byte,uint8_t addr);
int i2c_read (I2C_Control * dev, bool lastf, uint8_t *val8);
int i2c_read_bytes (I2C_Control * dev, uint8_t * val8, uint8_t len);
