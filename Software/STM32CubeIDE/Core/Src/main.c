...
/* USER CODE BEGIN PV */
//static const uint8_t TMP102_ADDR = 0x18 <<1; // Use 8-bit address
...
/* USER CODE BEGIN 4 */
// https://community.st.com/t5/stm32-mcus-products/how-to-setup-printf-to-print-message-to-console/td-p/174337
/**
