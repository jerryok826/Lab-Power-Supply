...
### Project Status
The project is basically complete. I am working on converting the design to Kicad and STM32 IDE Cube. Also I'm think abouting redoing the display board with a RP2040 running MicroPython. This should make it easy to the end user to add the features they want. For example adding WIFI control support.
