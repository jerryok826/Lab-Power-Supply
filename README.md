...
stm32f103c8t6 The display is a 256x128 OLED display. It is driven by uGui software. The control processor is a stm32f103c8t6 with
Arm Cortex-M3 MCU with 64 Kbytes of Flash memory and a 72 MHz CPU.
